...
if __name__ == '__main__':
    ...
    for dim in dims: 
        ...
        algorithms = [(GDE3, dict(variator=GAOperator(x, m)), 'GA_' + type(x).__name__ + '_' +
    ...
    os.chdir("./")
    bestFitness.to_csv('GDE3_experiment_%d_runs_dim_%s.csv' % (nexec,'_'.join(map(str, dims))))
